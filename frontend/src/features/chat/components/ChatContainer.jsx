  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      ...
      <div
        ...
        className="flex-1 overflow-y-auto p-2 sm:p-4 space-y-4 scrollbar-thin max-h-[calc(100vh-200px)] bg-base-100 rounded-lg border border-base-300"
        style={{ overscrollBehavior: "contain", display: "flex", flexDirection: "column", height: "500px" }}
      >
